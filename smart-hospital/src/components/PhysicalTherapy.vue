<!-- <template>
  ...
  export default {
    ...
    data() {
      return {
        ...
        translations: {
          EN: {
            departmentTitle: "Physical Therapy Department",
    ...
    methods: {
      async fetchDepartments() {
        try {
          const response = await fetch("http://localhost:1337/api/physical-therapies");
  ...
  export default {
    ...
    methods: {
      ...
      async fetchDepartments() {
        try {
          const response = await fetch(`http://localhost:1337/api/departments/3?populate=doctors`);
          const data = await response.json();
          console.log("Fetched data:", data);
